...
pfx6=mk2/s6_small_vol_dist/r18/0

if [[ ! -e $pfx6/final_0_8.pth ]];then
mkdir -p $pfx6
...
python aqc_training.py \
    ...
    --load $pfx5/best_loss_0_8.pth \
    --db qc_db_20250217_ref.sqlite3  \
    $pfx6 \
    --distcalc \
    --dist \
    --patch 192 \
    --noise 0.1 --lut 0.2  --nu 0.5 \
    --lin 0.05 \
    --n_epochs 50 \
    --folds 8 --fold 0 --batch 160 \
    --warmup_iter 4 --lr 0.001 --clip 4.0 --warmup_lr 1e-10 \
